...
const PUSH_TO_STAK = "PUSH_TO_STAK";
...
export default function fileReducer(state = defaultState, action) {
    switch (action.type) {
        ...
        case PUSH_TO_STAK: return { ...state, dirStack: [...state.dirStack, action.payload] }
...
export const pushToStack = (dir) => ({ type: PUSH_TO_STAK, payload: dir });
